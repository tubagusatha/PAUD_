    ...
    <div class="p-20 bg-slate-100">
        ...
        <div class="container mx-auto p-10 shadow-xl border bg-white rounded-xl ">
            ...
            <div class="bg-gray-100 p-6 rounded-lg shadow-lg space-y-4 mt-4">
                ...
                <form action="{{ route('sekdin.update', $permohonan->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <!-- Radio button untuk status -->
                    <div class="flex items-center mb-4">
                        <input type="radio" id="diteruskan" name="status_id" value="11" class="mr-2" required>
        ...
        <div class="text-center mt-10">
            @if ($role->role = 'SEKDIN')
                <h1 class="text-m">Masuk Sebagai SEKERTARIS DINAS</h1>
