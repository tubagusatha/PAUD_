    ...
    <div class="p-20 bg-slate-100">
        ...
        <div class="container mx-auto p-10 shadow-xl border bg-white rounded-xl ">
            ...
            <div class="bg-gray-100 p-6 rounded-lg shadow-lg space-y-4 mt-4">
                ...
                <form action="{{ route('jptjfu.update', $permohonan->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <!-- Radio button untuk status -->
                    <div class="flex items-center mb-4">
                        <input type="radio" id="diteruskan" name="status_id" value="8" class="mr-2" required>
                        <label for="diteruskan" class="text-gray-700">Teruskan Ke kasi</label>
                    </div>
                    <div class="flex items-center mb-4">
                        <input type="radio" id="diteruskan" name="status_id" value="6" class="mr-2" required>
                        <label for="diteruskan" class="text-gray-700">Perlu Perbaikan</label>
                    </div>
                    <div class="mb-5">
                        <label for="large-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">jika
                            perlu perbaikan isi dibawah ini</label>
        ...
        <div class="text-center mt-10">
            @if ($role->role = 'JPTJFU')
                <h1 class="text-m">Masuk Sebagai JPT/JFU</h1>
