...
@section('content')
    <div class="p-20 bg-slate-100">
        ...
        <div class="container mx-auto p-10 shadow-xl border bg-white rounded-xl ">
            <a class="bg-slate-600 text-white py-2 px-7 rounded-sm mt-2"
            ...
            <div class="bg-gray-100 p-6 rounded-lg shadow-lg space-y-4 mt-4">
                ...
                <form action="{{ route('kadis.update', $permohonan->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <!-- Radio button untuk status -->
                    <div class="flex items-center mb-4">
                        <input type="radio" id="diteruskan" name="status_id" value="3" class="mr-2" required>
                        <label for="diteruskan" class="text-gray-700">Disposisikan ke Kepala Bidang</label>
                    </div>
        ...
        <div class="text-center mt-10">
            @if ($role->role = 'KADIS')
            <h1 class="text-m">Masuk Sebagai KEPALA DINAS</h1>
