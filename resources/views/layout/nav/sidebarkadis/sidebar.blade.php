  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
     <div class="h-full px-3 pb-4 overflow-y-auto bg-slate-800 dark:bg-gray-800">
        ...
        <ul class="space-y-2 font-medium">
           <li class="mt-2">
              <a href="{{ route('kadis.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-slate-600 dark:hover:bg-gray-700 group">
           ...
           <li>
              <a href="{{ route('kadis.permohonan', ['uuid' => $user->uuid]) }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white  hover:bg-slate-600 dark:hover:bg-gray-700 group ">
